...
export default function WelcomePage() {
    ...
    const cityY = useTransform(scrollY, [0, 200], [0, -150])
    const cityOpacity = useTransform(scrollY, [0, 200, 300, 500], [1, 0.5, 0.5, 0])
    const heroY = useTransform(scrollY, [0, 200], [0, -200])
    const heroOpacity = useTransform(scrollY, [0, 200, 500], [1, 0.5, 0])
    const scaleY = useTransform(scrollY, [0, 200, 500], [0, 150, 400])
  ...
  return (
    <>
      <header id="welcome-header">
        <motion.div 
          style={{scale: scaleText, y: scaleY}}
